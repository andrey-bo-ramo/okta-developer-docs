  ...
  <div class="sidebar-area" v-if="sidebarItems.length > 0">
    <div class="sidebar-inner">
      <aside class="tree-nav">
        <div class="tree-nav-toggle active" v-on:click="handleSidebarClose">
          <svg
            width="16"
            height="14"
            viewBox="0 0 16 14"
        ...
        <div class="scroll-up" v-on:click="scrollUp">
          <svg
            width="10"
            height="12"
            viewBox="0 0 10 12"
...
export default {
  ...
  updated() {
    document
      ...
      .addEventListener("scroll", this.checkHeight);
    this.handleScroll();
  },
  watch: {
    $route(to, from) {
  ...
  methods: {
    ...
    handleScroll: function (event) {
      ...
      document.querySelector(".sidebar-area").style.height = maxHeight + "px";
    },
